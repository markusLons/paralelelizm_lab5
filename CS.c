...
///////////////////////////////////////////////////////////////////// Выбор видеокарт
    ...
    ncclUniqueId id;
    ncclComm_t comm;
    if (DEVICE == 0) ncclGetUniqueId(&id);
    MPI_Bcast(&id, sizeof(id), MPI_BYTE, 0, MPI_COMM_WORLD);
    ncclCommInitRank(&comm, COUNT_DEVICE, id, DEVICE);
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////// Выделения памяти
	...
	size_t offset = (DEVICE != 0) ? size : 0;
 	cudaMemcpyAsync(A_Device, A + (size * size * DEVICE / COUNT_DEVICE) - offset, sizeof(double) * size * size_y, cudaMemcpyHostToDevice);
	cudaMemcpyAsync(A_new_Device, A + (size * size * DEVICE / COUNT_DEVICE) - offset, sizeof(double) * size * size_y, cudaMemcpyHostToDevice);
